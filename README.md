...
The Bing News Search API uses Bing's search capabilities to get news articles from the web. This is a custom API built on top of Microsoft Azure Cognitive Services Search API. This API have 5 endpoints, which includes register, login,trending headlines, news articles accorting to search key, news articles according to category.
